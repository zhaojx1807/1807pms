	...
	<div class="box-positon">
		...
		<form class="ropt">
			<input class="add" type="button" value="添加"
				onClick="javascript:window.location.href='init.do'" />
		</form>
		<div class="clear"></div>
	</div>
	<div class="body-box">
		<form action="list.do" method="post" style="padding-top: 5px;">
			...
			<select name="isenabled">
				<c:if test="${QUERT.isenabled==0}">
					<option value="0">请选择</option>
					<option value="1">有效</option>
					<option value="-1">无效</option>
				</c:if>
				<c:if test="${QUERT.isenabled==1}">
					<option value="0">请选择</option>
				...
				<c:forEach items="${LIST}" var="user">
					<tr bgcolor="#ffffff" onMouseOut="this.bgColor='#ffffff'"
						...
						<td align="center"><a class="pn-opt"
							...
							href="userdelete.do?id=${user.id}">删除</a></td>
		...
		<div style="margin-top: 15px;">
			...
			<div style="float: right">
				<a href="userlist.do?page=1&loginname=${QUERY.loginname}&isenabled=${QUERY.isenabled}">第一页</a>&nbsp;&nbsp;&nbsp;&nbsp;<a
					href="userlist.do?page=${(PAGE-1)<=0?1:(PAGE-1)}&loginname=${QUERY.loginname}&isenabled=${QUERY.isenabled}">上一页</a>&nbsp;&nbsp;&nbsp;&nbsp;<a
					href="userlist.do?page=${PAGE+1>PAGECONT?PAGECONT:PAGE+1}&loginname=${QUERY.loginname}&isenabled=${QUERY.isenabled}">下一页</a>&nbsp;&nbsp;&nbsp;&nbsp;<a
					href="userlist.do?page=${PAGECONT}&loginname=${QUERY.loginname}&isenabled=${QUERY.isenabled}">最后页</a>&nbsp;&nbsp;&nbsp;&nbsp;当前第${PAGE}页
				/共${PAGECONT}页
			</div>
		</div>
</body>
